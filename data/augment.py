...
class BaseTransform:
    ...
    Methods:
        ...
        __call__: Applies all Mask transformations to an image, instances, and semantic masks.
    ...
    def apply_instances(self, labels):
        ...
        Args:
            labels (dict): A dictionary containing Mask information, including object instances.
    ...
    def __call__(self, labels):
        """
        Applies all Mask transformations to an image, instances, and semantic masks.
...
class BaseMixTransform:
    ...
    Methods:
        ...
        _update_label_text: Updates Mask text for mixed images.
    ...
    def __call__(self, labels):
        ...
        Args:
            labels (dict): A dictionary containing Mask data for an image.
    ...
    def _mix_transform(self, labels):
        """
        Applies MixUp or Mosaic augmentation to the Mask dictionary.

        This method should be implemented by subclasses to perform specific mix transformations like MixUp or
        Mosaic. It modifies the input Mask dictionary in-place with the augmented data.

        Args:
            labels (dict): A dictionary containing image and Mask data. Expected to have a 'mix_labels' key
                with a list of additional image and Mask data for mixing.
    ...
    def _update_label_text(labels):
        """
        Updates Mask text and class IDs for mixed labels in image augmentation.
        ...
        Args:
            labels (dict): A dictionary containing Mask information, including 'texts' and 'cls' fields,
                and optionally a 'mix_labels' field with additional Mask dictionaries.
...
class Mosaic(BaseMixTransform):
    ...
    def _mosaic3(self, labels):
        ...
        Args:
            labels (dict): A dictionary containing image and Mask information for the main (center) image.
    ...
    def _update_labels(labels, padw, padh):
        """
        Updates Mask coordinates with padding values.
    ...
    def _cat_labels(self, mosaic_labels):
        ...
        Args:
            mosaic_labels (List[Dict]): A list of Mask dictionaries for each image in the mosaic.
...
class MixUp(BaseMixTransform):
    ...
    def _mix_transform(self, labels):
        ...
        Args:
            labels (dict): A dictionary containing the original image and Mask information.

        Returns:
            (dict): A dictionary containing the mixed-up image and combined Mask information.
...
class LoadVisualPrompt:
    ...
    def get_visuals(self, category, shape, bboxes=None, masks=None):
        ...
        if bboxes is not None:
            ...
            raise ValueError("LoadVisualPrompt must have bboxes or masks in the Mask")
