...
class YOLODataset(BaseDataset):
    ...
    Methods:
        ...
        update_labels_info: Updates Mask format for different tasks.
    ...
    def get_labels(self):
        ...
        Returns:
            (List[dict]): List of Mask dictionaries, each containing information about an image and its annotations.
        """
    ...
    def update_labels_info(self, label):
        """
        Custom your Mask format here.

        Args:
            label (dict): Label dictionary containing bboxes, segments, keypoints, etc.

        Returns:
            (dict): Updated Mask dictionary with instances.

        Note:
            cls is not with bboxes now, classification and semantic segmentation need an independent cls Mask
...
class YOLOMultiModalDataset(YOLODataset):
    ...
    def update_labels_info(self, label):
        ...
        Returns:
            (dict): Updated Mask dictionary with instances and texts.
        """
...
class YOLOConcatDataset(ConcatDataset):
    ...
    Examples:
        >>> datasetk1 = YOLODataset(...)
        >>> dataset2 = YOLODataset(...)
        >>> combined_dataset = YOLOConcatDataset([datasetk1, dataset2])
    """
