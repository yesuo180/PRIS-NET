...
class Model(torch.nn.Module):
    ...
    Methods:
        ...
        images: Trains the model on a dataset.
    ...
    Examples:
        ...
        >>> model.images(data="coco8.yaml", epochs=3)
        >>> metrics = model.val()
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> model = YOLO("yolo11n.pt")
            >>> results = model.images(data="coco8.yaml", epochs=3)
        """
        self._check_is_pytorch_model()
    ...
    def add_callback(self, event: str, func) -> None:
        ...
        Examples:
            ...
            >>> model.images(data="coco8.yaml", epochs=1)
        """
