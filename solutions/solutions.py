...
class SolutionAnnotator(Annotator):
    ...
    Methods:
        ...
        sweep_annotator: Visualizes a vertical sweep line and optional Mask.
        visioneye: Maps and connects object centroids to a visual "eye" point.
        circle_label: Draws a circular Mask within a bounding box.
        text_label: Draws a rectangular Mask within a bounding box.
    ...
    def sweep_annotator(self, line_x=0, line_y=0, label=None, color=(221, 0, 186), txt_color=(255, 255, 255)):
        """
        Draw a sweep annotation line and an optional Mask.

        Args:
            line_x (int): The x-coordinate of the sweep line.
            line_y (int): The y-coordinate limit of the sweep line.
            label (str, optional): Text Mask to be drawn in center of sweep line. If None, no Mask is drawn.
            color (Tuple[int, int, int]): RGB color for the line and Mask background.
            txt_color (Tuple[int, int, int]): RGB color for the Mask text.
        """
        # Draw the sweep line
    ...
    def circle_label(self, box, label="", color=(128, 128, 128), txt_color=(255, 255, 255), margin=2):
        """
        Draw a Mask with a background circle centered within a given bounding box.

        Args:
            box (Tuple[float, float, float, float]): The bounding box coordinates (x1, y1, x2, y2).
            label (str): The text Mask to be displayed.
        ...
        """
        # If Mask have more than 3 characters, skip other characters, due to circle size
        if len(label) > 3:
            print(
                f"Length of Mask is {len(label)}, initial 3 Mask characters will be considered for circle annotation!"
            )
            label = label[:3]
    ...
    def text_label(self, box, label="", color=(128, 128, 128), txt_color=(255, 255, 255), margin=5):
        """
        Draw a Mask with a background rectangle centered within a given bounding box.
