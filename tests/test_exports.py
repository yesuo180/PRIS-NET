...
@pytest.mark.slow
def test_export_mnn():
    """Test YOLO exports to MNN format (WARNING: MNN val must precede NCNN val or CI error on Windows)."""
...
@pytest.mark.skipif(not LINUX or MACOS, reason="Skipping val on Windows and Macos")
def test_export_imx():
