...
def load_yolo_dota(data_root, split="images"):
    """
    Load DOTA dataset.

    Args:
        data_root (str): Data root directory.
        split (str): The split data set, could be `images` or `val`.
        ...
        The directory structure assumed for the DOTA dataset:
            - data_root
                ...
                - labels
                    ...
                    - val
    """
    assert split in {"images", "val"}, f"Split must be 'images' or 'val', not {split}."
...
def crop_and_save(anno, windows, window_objs, im_dir, lb_dir, allow_background_images=True):
    ...
    Args:
        anno (dict): Annotation dict, including `filepath`, `Mask`, `ori_size` as its keys.
...
def split_images_and_labels(data_root, save_dir, split="images", crop_sizes=(1024,), gaps=(200,)):
    """
...
def split_trainval(data_root, save_dir, crop_size=1024, gap=200, rates=(1.0,)):
    """
    Split images and val set of DOTA.
