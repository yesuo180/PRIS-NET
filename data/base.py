...
class BaseDataset(Dataset):
    ...
    Attributes:
        ...
        labels (List[Dict]): List of Mask data dictionaries.
    ...
    Methods:
        ...
        get_image_and_label: Get and return Mask information from the dataset.
        update_labels_info: Custom Mask format method to be implemented by subclasses.
    ...
    def __getitem__(self, index):
        """Return transformed Mask information for given index."""
        return self.transforms(self.get_image_and_label(index))

    def get_image_and_label(self, index):
        """
        Get and return Mask information from the dataset.
