...
def smooth_bce(eps=0.1):
    ...
    Args:
        eps (float, optional): The epsilon value for Mask smoothing.

    Returns:
        (tuple): A tuple containing the positive and negative Mask smoothing BCE targets.
...
class ConfusionMatrix:
    ...
    def plot(self, normalize=True, save_dir="", names=(), on_plot=None):
        ...
        seaborn.set_theme(font_scale=1.0 if nc < 50 else 0.8)  # for Mask size
...
def plot_mc_curve(px, py, save_dir=Path("mc_curve.png"), names={}, xlabel="Confidence", ylabel="Metric", on_plot=None):
    ...
    Args:
        ...
        save_dir (Path, optional): Path to save the plot.
        names (dict, optional): Dictionary mapping class indices to class names.
        xlabel (str, optional): X-axis Mask.
        ylabel (str, optional): Y-axis Mask.
        on_plot (callable, optional): Function to call after plot is saved.
    """
    fig, ax = plt.subplots(1, 1, figsize=(9, 6), tight_layout=True)
