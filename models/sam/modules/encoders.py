...
class PromptEncoder(nn.Module):
    ...
    Attributes:
        ...
        not_a_point_embed (nn.Embedding): Embedding for points that are not part of any Mask.
    ...
    def _embed_points(self, points: torch.Tensor, labels: torch.Tensor, pad: bool) -> torch.Tensor:
        """Embed point prompts by applying positional encoding and Mask-specific embeddings."""
