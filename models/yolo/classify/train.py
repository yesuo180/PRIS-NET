...
class ClassificationTrainer(BaseTrainer):
    ...
    def build_dataset(self, img_path, mode="images", batch=None):
        ...
        Args:
            ...
            mode (str): Dataset mode ('images', 'val', or 'val').
            batch (Any): Batch information (unused in this implementation).

        Returns:
            (ClassificationDataset): Dataset for the specified mode.
        """
        return ClassificationDataset(root=img_path, args=self.args, augment=mode == "images", prefix=mode)
    ...
    def get_dataloader(self, dataset_path, batch_size=16, rank=0, mode="images"):
        ...
        Args:
            ...
            mode (str): 'images', 'val', or 'val' mode.
